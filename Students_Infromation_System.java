...
public class Students_Infromation_System extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel13.setText("Student Credentials Management System");
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "AWS data analytics", "AWS cloud computing", "Paloalto Cyber Security", "NPTEL(Online Certification for Beginners)", "Cisco Networking Course", "Oracle Academy", "Code Chef Hackathon", "Celonis Fundamental", "AWS CLoud Foundation& Solution Architect", "Cohart AIML Virtual Internship" }));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(txt_present, javax.swing.GroupLayout.Alignment.TRAILING)
    ...
    private void cmd_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_searchActionPerformed
        ...
        try {
            ...
            if(rs.next())
            {
                ...
                String add9=rs.getString("Courses");
    ...
    private void cmd_saveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmd_saveActionPerformed
        ...
        try {
            ...
            String sql="insert into student_info (Roll,First_name,Last_name,Class,Year,Birth_date,Mobile_no,Sex,Courses,Present) values(?,?,?,?,?,?,?,?,?,?)";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(p==0)
        {
           try {
            ...
            String sql="Update student_info set Roll='"+value1+"',First_name='"+value2+"',Last_name='"+value3+"',Class='"+value4+"', Year='"+value5+"',Birth_date='"+value6+"',Mobile_no='"+value7+"',Sex='"+value8+"',Courses='"+value9+"',Present='"+value10+"' where Roll='"+value1+"'";        
